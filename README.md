...
| :--- | :--- |
| **Lenguajes** | `Python` `JavaScript` `C#` `PHP` `SQL` |
| **Frontend & Mobile** | `Vue.js` `Apache Cordova` `HTML5` `CSS3` |
| **Backend & Frameworks** | `Django` `ERPNext (Frappe)` `Node.js` |
| **Bases de Datos** | `MySQL` `MariaDB` `Postgres` |
...
<p align="left">
<a href="https://linkedin.com/in/mariajhosegarcia" target="blank"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="mariajhosegarcia" /></a>
<a href="https://www.youtube.com/@mariajhosegarcia" target="blank"><img src="https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="@mariajhosegarcia" /></a>
